#include <gmp.h>
	...
	#define mp_init_set(x, y)		mpq_init_set_q(x, y)
	#define mp_init_set_q(x, y)		mpq_init_set_q(x, y)
	#define mp_init_set_f(x, y)		mpq_init_set_f(x, y)
	...
	#define mp_init_set(x, y)		mpf_init_set_f(x, y)
	#define mp_init_set_f(x, y)		mpf_init_set_f(x, y)
	#define mp_init_set_q(x, y)		mpf_init_set_q(x, y)
